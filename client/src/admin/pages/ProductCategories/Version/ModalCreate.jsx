...
const ModalCreate = ({ fetchVersionData, selectedBrandId }) => {
  ...
  return (
    <span>
      <button className="btn btn-info" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasVersion" aria-controls="offcanvasVersion">+ Add Version</button>
      <div className="offcanvas offcanvas-end" data-bs-keyboard="true" data-bs-backdrop="static" tabIndex={-1} id="offcanvasVersion" aria-labelledby="offcanvasRightLabelVersion">
        <div className="offcanvas-header">
          <h5 className="offcanvas-title" id="offcanvasRightLabelVersion">Create Version</h5>
