...
const ModalDelete = ({ id, index, fetchDataColor }) => {
  ...
  return (
    <span>
      ...
      <div className="modal fade" id={`staticBackdrop-${index}`} data-bs-keyboard="true" tabIndex={-1} aria-labelledby="staticBackdropLabelColor" aria-hidden="true">
        <div className="modal-dialog modal-dialog-centered">
          <div className="modal-content">
            <div className="modal-header">
              <h1 className="modal-title fs-5" id="staticBackdropLabelColor">Are you sure you want to delete?</h1>
