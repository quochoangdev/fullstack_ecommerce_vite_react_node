...
import { readCapacity, readColor, readRam } from '../../services/adminApi.jsx'
            ...
            <tbody>
              {
                dataCapacity?.data?.capacity.map((item, index) => (
                  <tr key={index}>
                    ...
                    <td>{item?.name}</td>
                    <td className='text-end'>
                      <ModalEditCapacity item={item} index={`modal-del-${index}`} />
                      <ModalDeleteCapacity id={item?.id} index={`modal-del-${index}`} />
                    </td>
                  </tr>
                ))
              }
            ...
            <tbody>
              {dataRam?.data?.ram.map((item, index) => (
                <tr key={index}>
                  ...
                  <td>{item?.name}</td>
                  <td className='text-end'>
                    <ModalEditRam item={item} index={`modal-del-${index}`} />
                    <ModalDeleteRam id={item?.id} index={`modal-del-${index}`} />
                  </td>
                </tr>
              ))}
            </tbody>
