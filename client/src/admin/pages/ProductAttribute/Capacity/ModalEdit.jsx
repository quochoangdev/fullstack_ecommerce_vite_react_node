...
import { updateCapacity } from '../../../services/privateApi'
...
const ModalEdit = ({ item, index, fetchDataCapacity }) => {
  ...
  return (
    <span>
      <button className="btn btn-warning me-2" type="button" data-bs-toggle="offcanvas" data-bs-target={`#offcanvasCapacity-edit-${index}`} aria-controls="offcanvasCapacity-edit">Edit</button>
