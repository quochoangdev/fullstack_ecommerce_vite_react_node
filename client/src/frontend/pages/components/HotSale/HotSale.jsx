      ...
      <div className={cx('cs-hot-sale-bg', 'p-2')}>
        <div className={cx('row', 'd-flex', 'align-items-center', 'justify-content-between', 'mt-2')}>
          <div className={cx('col-4')}>
            <img className={cx('cs-hot-sale-img')} src='https://res.cloudinary.com/dqhj1sukr/image/upload/v1730135710/uploadLocal_ecommerce/hotsale%20cuoi%20tuan.gif' alt='Hot Sale Banner' />
          </div>
