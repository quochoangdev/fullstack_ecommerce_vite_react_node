  ...
  async up(queryInterface, Sequelize) {
    ...
    await queryInterface.bulkInsert(
      ...
      [
        // ----------- smartphone -----------
        // Apple
        { id: 1, name: "11", brand_id: 1 },
        { id: 2, name: "12", brand_id: 1 },
        { id: 3, name: "12 Pro", brand_id: 1 },
        { id: 4, name: "12 Pro Max", brand_id: 1 },
        { id: 5, name: "13", brand_id: 1 },
        { id: 6, name: "13 Pro", brand_id: 1 },
        { id: 7, name: "13 Pro Max", brand_id: 1 },
        { id: 8, name: "14", brand_id: 1 },
        { id: 9, name: "14 Pro", brand_id: 1 },
        { id: 10, name: "14 Pro Max", brand_id: 1 },
        { id: 11, name: "15", brand_id: 1 },
        { id: 12, name: "15 Pro", brand_id: 1 },
        { id: 13, name: "15 Pro Max", brand_id: 1 },
        { id: 14, name: "16", brand_id: 1 },
        { id: 15, name: "16 Pro", brand_id: 1 },
        { id: 16, name: "16 Pro Max", brand_id: 1 },
        { id: 17, name: "16 Plus", brand_id: 1 },
